...
public class JavConfig implements AppletContext, AppletStub {
	/*
	...
	public JavConfig(Map<String, String> params) {
		this.params = params;
	}
	...
	public String getInitialClass() {
		String className = params.get("initial_class");
	...
	public URL getCodeBase() {
		try {
			return new URL(params.get(Key.CODEBASE));
